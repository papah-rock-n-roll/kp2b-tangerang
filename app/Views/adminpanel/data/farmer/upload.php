...
<?php echo form_open_multipart($action) ?>
  ...
  <div class="card-body">
    <div class="callout callout-warning">
      ...
      <p>Primary Key "<strong>farmcode</strong>"</p>
    </div>
    <div class="form-group">
      <label for="">Tata Cara Import Dari Excel</label>
      <div>
        <img src="/themes/dist/img/sample-import-farm.png" alt="Thumbnail" class="img-fluid">
      </div>
    </div>
    <div class="form-group">
...
function filename() {
  ...
  const file = document.querySelector('#farm_file');
