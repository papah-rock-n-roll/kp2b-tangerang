...
<?php echo form_open_multipart($action) ?>
  ...
  <div class="card-body">
    <div class="callout callout-warning">
      ...
      <p>Primary Key "<strong>ownerid</strong>"</p>
    </div>
    <div class="form-group">
      <label for="">Tata Cara Import Dari Excel</label>
      <div>
        <img src="/themes/dist/img/sample-import-own.png" alt="Thumbnail" class="img-fluid">
      </div>
    </div>
    <div class="form-group">
      <label for="">Import File Pemilik</label>
      <div class="custom-file">
        <?php $custom = $validation->hasError('own_file') ? 'custom-file-label form-control is-invalid' : 'custom-file-label form-control' ?>
        <label class="<?= esc($custom) ?>" for="own_file">Choose file</label>
        <?php
        $import = [
          'id' => 'own_file',
...
function filename() {
  ...
  const file = document.querySelector('#own_file');
